function DiscAlg101(A,B,Q,R,U,bet,n1,n2,Vt1,Ct1,
...
#-----------------------------------------------------------------------
  ...
  (A11,A12,A21,A22) = (A[v1,v1],A[v1,v2],A[v2,v1],A[v2,v2])  #partitioning system matrices
  ...
  while any(maximum(Cdiff,dims=1) .> ConvCrit) & (iter < MaxIter)   #iterations
    ...
    (M,C,F,V) = DiscAlg102(Ct1,Vt1,R,bet,A11,A12,A21,A22,Q11,Q12,Q21,Q22,B1,B2,U1,U2)
...
function DiscAlg102(Ct1,Vst1,R,bet,A11,A12,A21,A22,Q11,Q12,Q21,Q22,B1,B2,U1,U2)
...
#-----------------------------------------------------------------------
  ...
  d1mat = inv(A22-Ct1*A12)                  #could perhaps pre-allocate these
  D     = d1mat * (Ct1*A11-A21)
  G     = d1mat * (Ct1*B1-B2)
