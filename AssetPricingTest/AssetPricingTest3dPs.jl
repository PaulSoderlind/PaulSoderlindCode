function AssetPricingTest3dPs(Re1,Re2,f,h,bandwidth=0,q=0,ExtraTest=[],ExtraTestq=[],
                              CrossRegType="beta",vvR=0)
...
#
#
#  Usage: fnOutput = AssetPricingTest3dPs(Re1,Re2,f,h,[,bandwidth[,q[,ExtraTest[,ExtraTestq[,
#                                         CrossRegType[,vvR]]]]]])
#
...
#           CrossRegType ('beta' or 'GLS') or {Kxn1;Lxn2} cell arrray, ['beta']
#           vvR          cell array of vectors, indices of moment conditions to test with R*g-q
#
#
